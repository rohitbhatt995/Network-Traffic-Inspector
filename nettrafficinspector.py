...
def geoip_city(string):
    if string in black_listed_ip:
        ...
        try:
            ...
            "\n"
            print
            '[*] Target : ' + string + ' Geo Located .'
            print
            " \n"
            print
            '[+] City: ' + str(pcity) + ', Region : ' + str(pregion) + ', Country: ' + str(pcountry)
            print
            "\n"
            print
            '[+] Latitude : ' + str(plat) + ', Longitude : ' + str(plong)
            print
            "\n"
        except:
            print
    ...
    for (ts, buf) in pcap:
        try:
            ...
            if src in black_listed_ip:
                ...
                "-------------------------------------------------------------------------------------------------"
                print
                '[+] Source IP: ' + str(src) + '------->  Destination IP: ' + str(dst)
                print
